...
public class Masmorra {
    ...
    private void inicializarMasmorra() {
        TipoRegiao[][] mapaTemplate = {
                ...
                /* Linha 2 */ { TipoRegiao.SALA_TESOURO, TipoRegiao.CORREDOR,     TipoRegiao.CORREDOR,     TipoRegiao.CORREDOR,     TipoRegiao.SALA_LOJA },
                /* Linha 3 */ { TipoRegiao.PAREDE,       TipoRegiao.PAREDE,       TipoRegiao.CORREDOR,     TipoRegiao.PAREDE,       TipoRegiao.PAREDE },
                /* Linha 4 */ { TipoRegiao.SALA_TESOURO, TipoRegiao.CORREDOR,     TipoRegiao.CORREDOR,     TipoRegiao.CORREDOR,     TipoRegiao.SALA_LOJA },
                /* Linha 5 */ { TipoRegiao.PAREDE,       TipoRegiao.PAREDE,       TipoRegiao.CORREDOR,     TipoRegiao.PAREDE,       TipoRegiao.PAREDE },
                /* Linha 6 */ { TipoRegiao.SALA_TESOURO, TipoRegiao.CORREDOR,     TipoRegiao.CORREDOR,     TipoRegiao.CORREDOR,     TipoRegiao.SALA_LOJA },
